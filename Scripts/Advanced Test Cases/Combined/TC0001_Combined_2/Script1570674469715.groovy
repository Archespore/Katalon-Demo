...
WebUI.click(findTestObject('Page_Appointment/input_None_programs'))
...
WebUI.callTestCase(findTestCase('Summary Page/Verify_Details'), [('Facility') : 'Tokyo CURA Healthcare Center', ('Readmission') : 'Yes'
        , ('Healthcare') : 'None', ('Dates') : '29/05/2019', ('Comment') : 'This is NOT a test'], FailureHandling.STOP_ON_FAILURE)
